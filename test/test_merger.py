...
class TestMerger(unittest.TestCase):
    ...
    def test_merge_different_tickers(self):
        ...
        self.assertEqual(stock_c.column(Column.Name.ADJCLOSE).data.shape[1], 2)
    ...
    def test_merge_different_columns(self):
        ...
        self.assertEqual(stock_c.column(Column.Name.ADJCLOSE).data.shape[1], 1)
        self.assertEqual(stock_c.column(Column.Name.CLOSE).data.shape[1], 1)
